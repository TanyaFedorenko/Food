...
throw new Error("Module parse failed: Identifier 'calc' has already been declared (2:9)\nYou may need an appropriate loader to handle this file type, currently no loaders are configured to process this file. See https://webpack.js.org/concepts#loaders\n| import calc from '../bundle';\n> function calc(){\n|  // Calculator\n| ");
...
function slider() { //slider
    ...
    slidesWrapper = document.querySelector('.offer__slider-wrapper'), //окно слайда
        width = window.getComputedStyle(slidesWrapper).width, //получаем ширину окна через которое будут показываться слайды
